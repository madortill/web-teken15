...
let objMedInfo = {
    ...
    "Loratadine-Desloratadine": {
        ...
        indication : "<ol class=list><li>נזלת אלרגית.</li><li>אורטיקריה (פריחה המתבטאת בנגעים אדומים בולטים בצורות שונות ומגרדות).</li></ol>",
    ...
    "Cephalosporines": {
        ...
        indication : "מגוון זיהומים חיידקיים.",
        contraindication : "אלרגיה לתרופה.",
        sideEffect : "נפוצות:<br><ol class=list><li>כאבי בטן.</li><li>שלשולים.</li><li>פריחה.</li></ol><br>נדירות:<br><ol class=list><li>דיכויי ייצור תאי דם במח העצם.</li><li>פגיעה כבדית (קלה) וכלייתית (בעיקר בחולים מבוגרים ו/או בעלי מחלה כלייתית כרונית).</li></ol>",
        patientGuidelines : "<ol class=list><li>לא להפסיק את הטיפול באמצע, אלא לסיים את כולו, גם אם מרגישים טוב יותר.</li><li>מומלץ לקחת אחרי אוכל, על בטן מלאה (כדי להפחית תופעות לוואי במערכת העיכול).</li><li>לפנות לבדיקה רפואית במקרה של שלשול ממושך (גם בשבועות שאחרי סיום הטיפול) – עלול להעיד על זיהום מסויים במעי הגס הדורש טיפול (CDAD).</li><li>לפנות לבדיקה רפואית אם מופיעה תגובה אלרגית, גם תגובה אלרגית קלה כמו פריחה.</li></ol>",
        mechanismOfAction : "פגיעה בבניית דופן התא של החיידקים ועל כן הריגה של החיידקים.",
    },
    "Macrolides": {
    ...
    "Fluoroquinolones": {
        ...
        patientGuidelines : `<ol class=list><li>לא להפסיק את הטיפול באמצע, אלא לסיים את כולו, גם אם מרגישים טוב יותר.</li><li>אין הכרח לקחת אחרי האוכל, אבל זה יכול להפחית תופעות לוואי במערכת העיכול.</li><li>לפנות לבדיקה רפואית במקרה של שלשול ממושך (גם בשבועות שאחרי סיום הטיפול) – עלול להעיד על זיהום מסויים במעי הגס הדורש טיפול (CDAD).</li><li>אין לקחת ביחד עם סותרי חומצה וויטמינים.</li><li>להימנע מפעולות הדורשת ערנות וריכוז אחרי לקיחת התקופה (בגלל הסיכון לתופעות לוואי נוירולוגיות).</li><li>מניעה מחשיפה ממושכת לשמש ושימוש בקרם הגנה (התרופה מגבירה רגישות של העור לשמש).</li><li>לפנות לבדיקה רפואית אם מופיעה תגובה אלרגית, גם תגובה אלרגית קלה כמו פריחה. כנ"ל אם מופיעות תופעות לוואי נוירולוגיות משמעותיות.</li></ol>`,
    ...
    "Simvastatin": {
        ...
        contraindication : "<ol class=list><li>אלרגיה לתרופה.</li><li>הפרעה בתפקוי כבד.</li></ol>",
    ...
    "Folic-Acid-VitaminB9": {
        ...
        indication : "<ol class=list><li>תוסף תזונה.</li><li>טיפול ומניעה של אנמיה כתוצאה ממחסור בחומצה פולית.</li><li>תוסף תזונתי בזמן הריון (הערה – מניעת מומים מולדים).</li></ol>",
        contraindication : "אלרגיה לתרופה.",
        sideEffect : "אין.",
    ...
    "Omeprazole": {
        ...
        contraindication : "אלרגיה לתרופה.",
        sideEffect : "<ol class=list><li>חוסר בויטמין B12 (הערה – חלק מהחומרים המופרשים מדופן הקיבה מסייעים בספיגת B12, והתרופה מעכבת גם אותם).</li><li>חוסר במגנזיום והחלשות עצמות.</li></ol>",
    ...
    "Parrafin": {
        ...
        indication : "<ol class=list><li>עצירות.</li><li>ריקון מעי לפני בדיקות, ניתוחים וכו...</li></ol>",
        contraindication : "<ol class=list><li>אלרגיה לתרופה.</li><li>דלקות במעי לרבות אפנדציטיס (דלקת בתוספתן) ודלקת במעי הגס .</li><li>קושי בבליעה (הערה – סכנת אספירציה).</li><li>חסימת מעיים .</li><li>בחילות/הקאות.</li></ol>",
        sideEffect : "<ol class=list><li>שלשולים .</li><li>כאבי בטן.</li></ol>",
        patientGuidelines : "<ol class=list><li>יש לרחת שעה לפני האוכל או שעתיים אחרי ארוחה, על בטן ריקה .</li><li>התרופה לא נועדה לשימוש ממושך מעל לשבוע.</li><li>ניתן לתת עד פעמיים ביום, 2 כפיות בכל פעם.</li></ol>",
    ...
    "Papaverine": {
        ...
        patientGuidelines : "<ol class=list><li>מומלץ לקחת אחרי ארוחה, על בטן מלאה .</li><li>להיזהר בשונויי תנוחות ופעולות הדורשות ערנות וריכוז (הערה – התרופה עלולה להוריד לחצי דם).</li></ol>",
    ...
    "Iburofen": {
        ...
        patientGuidelines : "<ol class=list><li>מומלץ לקחת לאחר ארוחה .</li><li>אסור לשתות אלכוהול במהלך הטיפול  (הערה – אלכוהול מגביר תופעות הלוואי).</li><li>ניתן לבלוע כדור כל 4-6 שעות, במידת הצורך.</li></ol>",
    },
    ...
    "Bismuth-Subsalicylate": {
        ...
        mechanismOfAction : "<ol class=list><li>הפחתת כאבי בטן (הערה – דיכוי תהליך דלקתי בדרכי העיכול).</li><li>הפחתת שלשולים (הערה – הפחתת תנועתיות של המעיים).</li></ol>",
    },
